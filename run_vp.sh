...
pulp-run --platform=gvsoc --config=pulp --binary="$binary" --dir="$out_dir" --trace="/sys/board/chip/cluster/*:$out_dir/log" --trace="/sys/board/chip/soc/fc/insn*:$out_dir/fc" prepare run
